...
<template>
  <div class="alpha">
    ...
    <delete-copy-experts-modal @close="hideDialog" v-if="dialogIsVisible" :selected-item="selectedItem"/>
    <div class="section-5">
      <div class="empty-state" v-if="this.getAllExpert.experts.length === 0" >
      ...
      <div class="table" v-if="this.getAllExpert.experts.length >0">
        <table>
          <tr>
            <th>Expert Name</th>
            <th>Expert Image</th>
            <th>Expert WinRate</th>
            <th>Profit Share</th>
            <th>Wins</th>
            <th>Losses</th>
            <th>Date</th>
          ...
          <tr>
            <td data-label="Expert Name">{{child.expertName}}</td>
            <td data-label="Expert Image">{{child.expertImage | formatTextWithEllipsis}}</td>
            <td data-label="Expert WinRate">{{child.expertWinRate}}</td>
            <td data-label="Profit Share">{{child.profitShare}}</td>
            <td data-label="Wins">{{child.Wins}}</td>
            <td data-label="Losses">{{child.Losses}}</td>
    ...
    <div style="color: white;" class="section-2-alpha">
      <p class="text-1">Add Copy Expert</p>
      <hr/>
      ...
      <form class="form" @submit.prevent="createUser" >
        ...
        <div class="space">
          ...
          <input type="text" v-model="model.expertName" required="required"  class="form-input"/>
        </div>

        <div class="space">
          <label>win rate</label>
          <input type="text" v-model="model.expertWinRate"   required="required"  class="form-input"/>
        </div>


        <div class="space">
          <label>Profit share</label>
          <input type="text" v-model="model.profitShare"  required="required" class="form-input"/>
        </div>


        <div class="space">
          <label>Wins</label>
          <input type="text" v-model="model.wins"  required="required" class="form-input"/>
        </div>

        <div class="space">
          <label>Losses</label>
          <input type="text" v-model="model.losses"  required="required" class="form-input"/>
        </div>
...
import DeleteCopyExpertsModal from "@/components/BaseComponents/modal/DeleteCopyExpertsModal.vue";

export default {
  name: "DashBoardAddCopyExperts",
  components: {DeleteCopyExpertsModal, BaseLoader2, BaseButton,},
  data () {
    return {
      model: new ExpertRequest().createExpert,
      base64: "",
  ...
  methods: {
    ...
    // clearForm(){
    //   this.model.expertName = "";
    //   this.model.expertWinRate = "";
    //   this.model.profitShare = "";
    //   this.model.wins = "";
    //   this.model.losses = "";
    // },
    ...
    async showDialog(child) {
      this.selectedItem = child.expertId;
    ...
    async createUser() {
      await StoreUtils.dispatch(StoreUtils.actions.expert.expertCreate, {
        userId: 1,
        expertImage: this.url,
        expertName: this.model.expertName,
        expertWinRate: this.model.expertWinRate,
      ...
      this.clearForm()
      await StoreUtils.dispatch(StoreUtils.actions.expert.readAllExpert)
    },
