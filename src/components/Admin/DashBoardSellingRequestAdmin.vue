  ...
  <div class="alpha">
    <div class="body">
      ...
      <div class="row trans-mgt">
        ...
        <div class="form-group fg--search">
          ...
          <input type="text" class="input" placeholder="Search Selling Requests..." v-model="searchQuery" @input="filterTrades"/>
        </div>
    ...
    <div class="section-5">
      <div class="empty-state"  >
        ...
        <p class="empty-state-text-2">This is where your Selling Requests will appear</p>
      ...
      <!--              &lt;!&ndash;              <button  class="btn" @click="navigateWithParams(child)">Edit</button>&ndash;&gt;-->
      <!--              <a-->
...
export default {
  name: "DashBoardSellingRequestAdmin",
  data () {
    return {
      SelectEmail: "",
      history: [],
