  ...
  <div class="alpha">
    <div class="body">
      ...
      <div class="row trans-mgt">
        ...
        <div class="form-group fg--search">
          ...
          <input type="text" class="input" placeholder="Search Buying Requests..." v-model="searchQuery" @input="filterTrades"/>
        </div>
    ...
    <div class="section-5">
      <div class="empty-state"  >
        ...
        <p class="empty-state-text-2">This is where your Buying Requests will appear</p>
...
export default {
  name: "DashBoardBuyingRequestAdmin",
  data () {
    return {
      SelectEmail: "",
      history: [],
