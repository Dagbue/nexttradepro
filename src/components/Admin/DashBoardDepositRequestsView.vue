...
<!--        </div>-->
    ...
    <div class="section-5">
      <div class="empty-state" v-if="this.allDeposits.deposits.length === 0">
...
export default {
  ...
  methods: {
    ...
    async approve(child) {
      await StoreUtils.dispatch(StoreUtils.actions.deposit.updateDepositStatus, {
        depositId: child.depositId,
        depositStatus: "approved",
      });
      await StoreUtils.dispatch(StoreUtils.actions.deposit.readAllDeposit)
    },
  ...
  created() {
    ...
    StoreUtils.rootGetters(StoreUtils.getters.deposit.getAllDeposit)
  },
  ...
  mounted() {
    ...
    StoreUtils.dispatch(StoreUtils.actions.deposit.readAllDeposit)
  }
}
</script>
