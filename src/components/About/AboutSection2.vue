...
<!--        <div class="text-part">-->
<!--          <p class="text-1">Maximize Your Trading Potential</p>-->
<!--          <p class="text-2">-->
<!--            Unlock higher rewards with larger investments on our advanced trading platform.-->
<!--          </p>-->
<!--          <br/>-->
...
<!--        </div>-->
      ...
      <div class="section-2">
        ...
        <img src="@/assets/aboutimag1.jpg" alt="image" class="image" />
