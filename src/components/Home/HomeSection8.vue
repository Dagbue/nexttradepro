<template>
  <div class="alpha">
    ...
    <div class="section-alpha">
      ...
      <div class="section-1">
        <div class="text-1">Get started in minutes
        ...
        <p class="text-2">Our customers love how fast and simple our sign-up is. It takes just a few minutes to get started!</p>
      ...
      <div class="section-2">
        <img src="@/assets/afro-cta.png" alt="" class="image" />
