...
<!--    </div>-->
    ...
    <br/>
    <watch-list-table v-show="this.screen5 === 'pnl'"/>

    <div v-show="this.screen5 === 'placeTrade'">
      ...
      <div v-show="this.screen1 === 'RealEstate'"  class="separate">
    ...
    <div v-show="this.screen5 === 'TradeHistory'" class="last">
      <div class="body">
    ...
    <div v-show="this.screen5 === 'Buying'" class="last">
      <div class="body">
        <h2>My Buying history</h2>
        <div class="row trans-mgt">
          <div class="form-group fg--search">
            <button type="submit" @click.prevent="filterTrades"><i class="fa fa-search"></i></button>
            <input style="color: #FFFFFF;" type="text" class="input" placeholder="Search Buying history..." v-model="searchQuery" @input="filterTrades"/>
          </div>
          <div class="row filter_group">
            <div class="action-content">
              <p>Filter</p>
...
<!--        </div>-->
    ...
    <div v-show="this.screen5 === 'Selling'" class="last">
      <div class="body">
        <h2>My Selling history</h2>
        <div class="row trans-mgt">
          <div class="form-group fg--search">
            <button type="submit" @click.prevent="filterTrades"><i class="fa fa-search"></i></button>
            <input style="color: #FFFFFF;" type="text" class="input" placeholder="Search Selling history..." v-model="searchQuery" @input="filterTrades"/>
          </div>
          <div class="row filter_group">
            <div class="action-content">
              <p>Filter</p>
