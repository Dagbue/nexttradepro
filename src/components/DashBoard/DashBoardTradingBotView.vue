<template>
  <div class="alpha">
    <div class="body">
      ...
      <div class="row trans-mgt">
        ...
        <div class="form-group fg--search">
          ...
          <input style="color: #FFFFFF;" type="text" class="input" placeholder="Search Bots..." />
        </div>
    ...
    <div class="empty-state-container" v-if="this.getAllTradeBot.tradingBots.length === 0">
      <img src="@/assets/empty.svg" alt="empty" class="empty-state">
      <p class="empty-state-text-1">You have nothing to see</p>
      <p class="empty-state-text-2">This is where Trading Bots will appear</p>
    </div>

    <div v-if="this.getAllTradeBot.tradingBots.length >0" class="section-alpha">

      <div v-for="child in paginatedItems" :key="child.key" class="section-1">

        <img :src="child.botImage" alt="" class="image-section-1" />

        <p class="text-1-section-1">{{child.botName}}</p>

        <div class="rate-part-alpha">

          <div class="rate-inner">
            <p class="text-2">Win rate</p>
            <p class="text-3">{{child.botWinRate}}</p>
          </div>

          <div class="rate-inner">
            <p class="text-2">Price</p>
            <p class="text-3">${{child.botPrice}} per bot</p>
            <p class="text-3">0.07874759 BTC</p>
          </div>
    ...
    <div class="pagination" v-if="this.getAllTradeBot.tradingBots.length >0">
